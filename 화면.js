...
function 마무리() {
  ...
  if (!묶) {
    ...
    마지막결과 = {
      연습: true, 묶음키: null, 걸린초, 문제수: 결과들.length, 정답수,
  ...
  마지막결과 = {
    연습: false, 묶음키: 묶.키, 걸린초, 문제수: 결과들.length, 정답수,
